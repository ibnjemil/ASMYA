  ...
  try {
    ...
    if (userId) {
      ...
      for (const m of membersRes.rows) {
        ...
        membersByChat[cid].push({ id: m.userId, username: m.username, displayName: m.displayName, avatarUrl: m.avatarUrl, role: m.role, side: m.userSide })
      }
    ...
    if (chatId) {
      ...
      const members = membersRes.rows.map((m: any) => ({ id: m.userId, username: m.username, displayName: m.displayName, avatarUrl: m.avatarUrl, role: m.role, side: m.userSide }))
